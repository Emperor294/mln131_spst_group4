...
import { MUSEUM_LAYOUT_STATION_POSITIONS } from "./museum-layout-v2";
...
export const MUSEUM_CONCEPT_STATIONS: readonly MuseumConceptStation[] = [
  {
    ...
    position: MUSEUM_LAYOUT_STATION_POSITIONS["station-zone01-origins"],
    interactionRadius: 5,
    label: "KHỞI NGUỒN",
  },
  {
    ...
    position: MUSEUM_LAYOUT_STATION_POSITIONS["station-zone01-method"],
    interactionRadius: 5,
    label: "NỀN TẢNG",
  },
  {
    ...
    position: MUSEUM_LAYOUT_STATION_POSITIONS["station-zone02-worker"],
    interactionRadius: 5,
    label: "GIAI CẤP",
  },
  {
    ...
    position: MUSEUM_LAYOUT_STATION_POSITIONS["station-zone02-conditions"],
    interactionRadius: 5,
    label: "THỰC HIỆN",
  },
  {
    ...
    position: MUSEUM_LAYOUT_STATION_POSITIONS["station-zone03-socialism"],
    interactionRadius: 5,
  ...
  },
  {
    ...
    position: MUSEUM_LAYOUT_STATION_POSITIONS["station-zone03-transition"],
    interactionRadius: 5,
    label: "CHUYỂN TIẾP",
  },
  {
    ...
    position: MUSEUM_LAYOUT_STATION_POSITIONS["station-zone04-democracy"],
    interactionRadius: 5,
  ...
  },
  {
    ...
    position: MUSEUM_LAYOUT_STATION_POSITIONS["station-zone04-relationship"],
    interactionRadius: 5,
    label: "MỐI QUAN HỆ",
  },
  {
    ...
    position: MUSEUM_LAYOUT_STATION_POSITIONS["station-zone05-structure"],
    interactionRadius: 5,
    label: "CƠ CẤU",
  },
  {
    ...
    position: MUSEUM_LAYOUT_STATION_POSITIONS["station-zone05-necessity"],
    interactionRadius: 5,
    label: "TÍNH TẤT YẾU",
    variant: "alliance",
  },
  {
    ...
    position: MUSEUM_LAYOUT_STATION_POSITIONS["station-zone05-alliance"],
    interactionRadius: 5,
    label: "LIÊN MINH",
    variant: "alliance",
  },
  {
    ...
    position: MUSEUM_LAYOUT_STATION_POSITIONS["station-zone06-nation"],
    interactionRadius: 5,
    label: "DÂN TỘC",
  },
  {
    ...
    position: MUSEUM_LAYOUT_STATION_POSITIONS["station-zone06-religion"],
    interactionRadius: 5,
    label: "TÔN GIÁO",
  },
  {
    ...
    position: MUSEUM_LAYOUT_STATION_POSITIONS["station-zone06-relations"],
    interactionRadius: 5,
  ...
  },
  {
    ...
    position: MUSEUM_LAYOUT_STATION_POSITIONS["station-zone07-position"],
    interactionRadius: 5,
  ...
  },
  {
    ...
    position: MUSEUM_LAYOUT_STATION_POSITIONS["station-zone07-foundations"],
    interactionRadius: 5,
    label: "NỀN TẢNG",
  },
  {
    ...
    position: MUSEUM_LAYOUT_STATION_POSITIONS["station-zone07-vietnam"],
    interactionRadius: 5,
