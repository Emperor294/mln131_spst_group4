...
export const CHAPTER_TEXTBOOK_PAGE_MAP: readonly ChapterTextbookPageMapping[] = [
  {
    ...
    sourceRef: { id: "ref-ch01-textbook", sourceId: MLN131_TEXTBOOK_SOURCE_ID, bookPages: { start: 11, end: 49 }, pdfPages: { start: 8, end: 46 } },
    status: "verified",
  },
  {
    chapterId: "chapter-02",
    sourceRef: { id: "ref-ch02-textbook", sourceId: MLN131_TEXTBOOK_SOURCE_ID, bookPages: { start: 51, end: 84 }, pdfPages: { start: 48, end: 81 } },
    status: "verified",
  },
  {
  ...
  },
  {
    ...
    sourceRef: { id: "ref-ch04-textbook", sourceId: MLN131_TEXTBOOK_SOURCE_ID, bookPages: { start: 125, end: 163 }, pdfPages: { start: 122, end: 160 } },
    status: "verified",
  },
  {
    chapterId: "chapter-05",
    sourceRef: { id: "ref-ch05-textbook", sourceId: MLN131_TEXTBOOK_SOURCE_ID, bookPages: { start: 165, end: 193 }, pdfPages: { start: 162, end: 190 } },
    status: "verified",
  },
  {
    chapterId: "chapter-06",
    sourceRef: { id: "ref-ch06-textbook", sourceId: MLN131_TEXTBOOK_SOURCE_ID, bookPages: { start: 195, end: 237 }, pdfPages: { start: 192, end: 234 } },
    status: "verified",
  },
  {
