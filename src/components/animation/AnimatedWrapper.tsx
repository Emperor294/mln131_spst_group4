...
export const FadeUp = ({ 
  ...
  return (
    <motion.div
      className={className}
      initial={prefersReducedMotion ? false : { opacity: 0, ...initialPosition }}
      whileInView={prefersReducedMotion ? undefined : { opacity: 1, ...animatePosition }}
      viewport={{ once }}
      transition={{ 
        duration: duration,
        delay: delay
...
export const ClientAnimatedSection = ({ 
  ...
  return (
    <motion.section
      className={className}
      initial={prefersReducedMotion ? false : initialAnimationState()}
      animate={prefersReducedMotion ? undefined : isMounted ? finalAnimationState() : initialAnimationState()}
